...
>
  ...
  >
    ...
    <div className="relative p-[3px] rounded-[32px] bg-gradient-to-br from-[#10B981] via-[#34D399] to-[#064E3B]">
      ...
      {/* Carte */}
      <div className="relative w-[360px] h-[450px] rounded-[30px] overflow-hidden bg-[#111827]">
        ...
        >
          <div className="flex items-center gap-3 bg-black/50 backdrop-blur-xl border border-[#10B981]/40 px-5 py-3 rounded-full">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {[
                ...
                <motion.div
                  ...
                  className="bg-[#1A2234] border border-white/10 rounded-2xl p-5 flex items-center gap-4"
                >
                  {item.icon}
