  ...
  const categories = [
    ...
    },
    {
      ...
      skills: [
        {
          name: "PHP",
          icon: <FaPhp className="text-indigo-400 text-xl" />,
        },
        {
          name: "Laravel",
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Figma",
          icon: <FaFigma className="text-pink-500 text-xl" />,
        },
        {
          name: "ChatGPT",
          icon: <FaRobot className="text-green-500 text-xl" />,
        },
        {
          name: "Claude",
          icon: <FaRobot className="text-orange-400 text-xl" />,
        },
      ],
    },
    {
